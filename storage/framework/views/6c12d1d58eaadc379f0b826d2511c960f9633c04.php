...
<!--     <div class="row">
        <form action="<?php echo e(url('/notify')); ?>" method="POST">
...
xhr.open('POST', "<?php echo e(url('/api/send-notification/'.auth()->user()->id)); ?>", true);
xhr.onload = function () {
...
function registerServiceWorker() {
  return navigator.serviceWorker.register('<?php echo e(url("/js/app_service_worker/service-worker.js")); ?>')
  ...
  .then(function(registration) {
    ...
    const subscribeOptions = {
      ...
      applicationServerKey: urlBase64ToUint8Array(
        "BIkxY8twAZOHu5p-DvpdqWaw95zIdGBYzvb57jluo3uXywEn_WF015PIEPKcESEg309bEY3IjxreEGt-CmK1GQc"
      )
    };
    // alert("aya")
...
function sendSubscriptionToBackEnd(subscription) {
  return fetch('/api/save-subscription/<?php echo e(Auth::user()->id); ?>', {
    method: 'POST',
    headers: {
